...
namespace App\Http\Controllers\API\Backend\SupportTicket;
...
{   
    ...
    public function index(Request $request)
    {
        ...
        if (Auth::user()->role == 'superadmin') {
            $supportTicketData = SupportTicket::orderBy('id', 'desc')->with(['ticketByData','supportTicketDetailData'])->get();
            $allSupportTicketCount = SupportTicket::orderBy('id', 'desc')->with(['ticketByData','supportTicketDetailData'])->count();
        }else{
            $supportTicketData = SupportTicket::orderBy('id', 'desc')->with(['ticketByData','supportTicketDetailData'])->where('user_id', $userId)->get();
            $allSupportTicketCount = SupportTicket::orderBy('id', 'desc')->with(['ticketByData','supportTicketDetailData'])->where('user_id', $userId)->count();
        }
    ...
    public function create(Request $request)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json([
                'message' => 'Support type fetched successfully.',
                'status_code' => 200,
    ...
    public function supportTicketDetail(Request $request, $id)
    {
        ...
        $supportTicketDetails = SupportTicket::with(['ticketByData','supportTicketDetailData' => function ($query) {
