...
class AccountController extends Controller
{
    ...
    public function inactive(Request $request, $id)
    {
        ...
        return redirect()
                ->back()
                ->with('success', 'Account in-activated  successfully');
    }
    ...
    public function accountProfile(Request $request, $id)
    {
        ...
        $singleAccountData = Account::where('id', $id)->first();
        $accountTransferData = AccountTransfer::orderBy('transfer_date', 'desc')->where('account_id', $singleAccountData->id)->with(['transferByData'])->paginate(10);
        ...
        return Inertia::render('Backend/Account/Profile/Index', [
            'singleAccountData' => $singleAccountData,
            'accountTransferData' => $accountTransferData,
            'allAccountTransferCount' => $allAccountTransferCount,
        ]);
