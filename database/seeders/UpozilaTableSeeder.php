...
class UpozilaTableSeeder extends Seeder
{
    public function run()
    {
        $upozilaData = [
            ...
            [
                ...
                'name_en' => 'Kishorganj',
                'name_bn' => 'কিশোরগঞ্জ',
                'url' => 'kishorganj.wilphamari.gov.bd'
            ],
            [
                'id' => '427',
                'district_id' => '56',
            ...
            [
                'id' => '493',
                'district_id' => '8',
                'name_en' => 'Chittagong City',
                'name_bn' => 'চট্টগ্রাম শহর',
                'url' => 'rangunia.chittagong.gov.bd'
            ],
        ];

        Upozila::insert($upozilaData);
    }
}