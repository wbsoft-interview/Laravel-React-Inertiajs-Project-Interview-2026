...
<div class="row min-vh-100">
    ...
    <form action="{{route('save-all-income-receipt')}}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered py-3" id="updateIncomeDetails">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="modal fade" id="editIncomeReceipt{{$item->id}}" tabindex="-1" aria-labelledby="oneInputModalLabel"
                                                        ...
                                                        <form action="#" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row px-4 my-4">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        <div class="form-group custom-select2-form">
                                                                            <label for="income_category_id">Income Category <span
                                                                                    class=" text-danger">*</span>
                                                                            </label>
                                                                            <select name="income_category_id" id="income_category_id{{$item->id}}"
                                                                                class="form-select select2" onchange="getIncomeDataWithCateFU({{$item->id}})"
                                                                                required>
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" name="income_amount" id="income_amount{{$item->id}}" required
                                                                                class="form-control form-control-solid" value="{{$item->income_amount}}"
                                                                                step="0.01" placeholder="Income Amount">
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-12 mb-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea rows="3" cols="3" name="income_details" id="income_details{{$item->id}}"
                                                                                required class="form-control form-control-solid" value=""
                                                                                placeholder="Income Details">{{$item->income_details}}</textarea>
                                                                        </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-success"
                                                                    onclick="updateIncomeReceipt({{$item->id}})">Update</button>
    ...
    <div class="modal fade" id="addIncomeReceipt" tabindex="-1" aria-labelledby="oneInputModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered max-width-900px">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="oneInputModalLabel">New Income Receipt</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="#" method="post" enctype="multipart/form-data" onsubmit="return addNewIncomeReceipt()">
                    ...
                    <div class="modal-body p-0">
                        <div class="row px-4 my-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group custom-select2-form
                                {{$incomeCategoryData->count() > 0 ? '' : 'custom-null-select2-body'}}
                                ">
                                    <label for="income_category_id">Income Category <span
                                            class=" text-danger">*</span>
                                    </label>
                                    <select name="income_category_id" id="income_category_id"
                                        class="form-select select2" onchange="getIncomeDataWithCate()" required>
                                        <option value="" selected disabled>Select Category</option>
                                        @foreach($incomeCategoryData as $singleECD)
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="income_amount">Income Amount<span
                                            class="text-danger">*</span>
                                    </label>
                                    <input type="number" name="income_amount" id="income_amount" required
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label for="income_details">Income Details<span
                                            class="text-danger">*</span>
                                    </label>
                                    <textarea rows="3" cols="3" name="income_details" id="income_details" required
                                        class="form-control form-control-solid" value=""
                                        placeholder="Income Details"></textarea>
                                </div>
