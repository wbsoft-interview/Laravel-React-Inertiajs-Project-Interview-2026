...
@section('blog.edits') active @endsection
@section('styles')
@endsection
...
<div class="row py-3 ps-2">
    <div class="heading d-flex justify-content-start align-items-center">
        <h3 class="mb-0"><span> Blog Update</span></h3>
    </div>
</div>
...
<div class="app-content content ">
    <div class="card">
        <div class="card-body">
            <form action="{{route('blog.update', $singleBlogData->id)}}" method="post" enctype="multipart/form-data" onsubmit="return checkValidate()">
                @csrf
                @method('put')
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-2">
                            <div class="mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{$singleBlogData->title}}" required class="form-control" placeholder="Title ">
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="form-group custom-select2-form">
                                    ...
                                    <select name="blog_category_id" id="blog_category_id" class="form-select select2" required>
                                        ...
                                        <option value="{{$singleBCD->id}}"
                                            {{$singleBCD->id == $singleBlogData->blog_category_id ? 'selected' : ''}}
                                            >{{$singleBCD->category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="form-group form_add_new_post">
                                    ...
                                    <textarea class="fomr-control summernote" id="post_details" name="post">{!! str_replace(['../', '../../'], '../../', $singleBlogData->post) !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" position-relative custom-soft-setting dropzone">
                                        <div class="select_imgWith_preview py-2">
                                            <img id="uploadPreview1" src="{{ isset($singleBlogData) && $singleBlogData?->photo ? Storage::url('uploads/blogImg/' . $singleBlogData->photo) : asset('backend/template-assets/images/img_preview.png') }}">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-top: 15px;">
                            <button type="submit" class="btn btn btn-success m-0 py-2 text-right">Update</button>
                        </div>
