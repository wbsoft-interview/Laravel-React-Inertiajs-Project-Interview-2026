...
<div class="row min-vh-100">
    ...
    <form action="{{route('save-all-expense-receipt')}}" method="POST" enctype="multipart/form-data" id="billingRootForm"
        class="p-0">
        @csrf
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-start w-50">
                                                    <span class="text-secondary">{{$item->expense_details}}</span>
                                                </td>
                                ...
                                <div class="col-md-6">
                                    <div class="w-100 d-flex gap-2">
                                        ...
                                        <div class="d-flex flex-column gap-2 w-50">
                                            <input type="text" name="sub_total_expense_quantity" id="sub_total_expense_quantity"
                                            ...
                                            <input type="text" name="sub_total_expense_amount" id="sub_total_expense_amount"
                                                class="form-control custom-cursor-pointer custom-readonly-bg-color"
        ...
        <div class="modal-dialog modal-dialog-centered max-width-900px">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="oneInputModalLabel">Add Expense To Receipt</h1>
                    ...
                    <div class="modal-body p-0">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group custom-select2-form">
                                    ...
                                    <select name="expense_category_id" id="expense_category_id" class="form-select select2"
                                        onchange="getExpenseDataWithCate()" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="expense_amount" id="expense_amount" required class="form-control form-control-solid"
                                    value="" step="0.01" placeholder="Expense Amount">
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea rows="3" cols="3" name="expense_details" id="expense_details" required class="form-control form-control-solid"
                                    value="" placeholder="Expense Details"></textarea>
                            </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.error){
                        ...
                        $('#expense_category_id'+id).val(null).trigger("change");
                        $('#expense_id'+id).val(null).trigger("change");
                        $('#payee_id'+id).val(null).trigger("change");
                        $('#expense_amount'+id).val('');
                        $('#expense_details'+id).val('');
                        $('#updateExpenseDetails').html(data);
