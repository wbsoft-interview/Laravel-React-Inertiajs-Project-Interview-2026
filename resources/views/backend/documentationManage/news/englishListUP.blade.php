...
@section('title') Unpublished English News | Sangbad Protikhon @endsection
...
<div class="row py-3 ps-2">
    <div class="heading d-flex justify-content-start align-items-center">
        <h3 class="mb-0"><span>Unpublished English News List</span></h3>
    </div>
</div>
...
<div class="table_wrapper py-1 card">
    ...
    <div class="row px-3">
        ...
        @if(isset($unpublishedNewsCount) && $unpublishedNewsCount > 10)
