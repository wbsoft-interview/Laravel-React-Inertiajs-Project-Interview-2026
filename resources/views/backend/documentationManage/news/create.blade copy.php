...
@section('title', 'News | Master Template')
@section('news', 'active')
@section('news.index', 'active')
...
@section('main_content_section')
    <div class="row py-3 ps-2">
        <div class="heading d-flex justify-content-start align-items-center">
            <h3 class="mb-0"><span>News Create</span></h3>
        </div>
    </div>

    <div class="app-content content">
        <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data" onsubmit="return checkValidate()" novalidate>
            @csrf
            <div class="row">
                <div class="col-8">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="form-group">
                                        <label for="post_details" class="form-label">Description <span class="text-danger">*</span></label>
                                        <textarea id="post_details" name="post" class="form-control summernote">{{ old('post') }}</textarea>
                                        <span id="warnTextDesc1" class="text-danger warn d-none">Description is
                                            required</span>
                                        @error('post')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="mb-3">
                                            <label for="photo_text" class="form-label">Photo Text<span
                                                    class="text-danger">*</span></label>
                                            <textarea id="photo_text" name="photo_text" class="form-control summernote">{{ old('photo_text') }}</textarea>
                                            <span id="warnTextDesc2" class="text-danger warn d-none">Photo Text is
                                                required</span>
                                            @error('photo_text')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                ...
                <div class="col-4">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="body-section">
                                        ...
                                        <p class="d-flex gap-2 mb-1">
                                            <i class="fa fa-calendar my-auto"></i>
                                            <span class="my-auto">News Type: <b id="newsTypeText">Normal News</b></span>
                                        </p>
                                
                                        <p class="d-flex gap-2 mb-1">
                                            <i class="fa fa-calendar my-auto"></i>
                                            <span class="my-auto">News Format: <b id="newsFormatText">Col 1</b></span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="pb-0 mb-0">News Categories</h4>
                                </div>
                                <div class="card-body">
                                    <div class="categories-list">
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="category{{ $category->id }}" name="news_category_id[]"
                                                value="{{ $category->id }}">
                                        ...
                                        <div class="subcategory ps-4">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="category{{ $subcategory->id }}"
                                                    name="news_category_id[]" value="{{ $subcategory->id }}">
                                                <label class="form-check-label"
                                                    for="category{{ $subcategory->id }}">{{ $subcategory->category_name }}</label>
                                            </div>
                                            @endforeach
                                        </div>
                                        @endif
                        ...
                        <div class="col-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="pb-0 mb-0">News Tags</h4>
                                </div>
                                <div class="card-body">
                                    <!-- User -->
                                    <div class="mb-3">
                                        <div class="form-group custom-select2-form">
                                            <label for="news_tag_id">Tags <span class=" text-danger"></span>
                                            </label>
                                            <select name="news_tag_id[]" id="news_tag_id" class="form-select select2" multiple>
                                                <option value="" disabled>Select Tag</option>
                                                @foreach ($newsTagData as $singleNTData)
                                                <option value="{{ $singleNTData->id }}" {{ old('news_tag_id') == $singleNTData->id ? 'selected' : '' }}>
                                                    {{ $singleNTData->tag_name }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="row px-4 my-4">
                                ...
                                <div class="mb-3 col-md-4">
                                    <div class="form-group custom-select2-form">
                                        ...
                                        <select name="published_by_id" id="published_by_id" class="form-select select2" required>
                                            <option value="" selected disabled>Select User</option>
                                            @foreach ($userData as $singleUData)
                                            <option value="{{ $singleUData->id }}" {{ old('published_by_id') == $singleUData->id ? 'selected' : '' }}>
                                                {{ $singleUData->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-3 col-md-4">
                                    <div class="form-group custom-select2-form">
                                        <label for="news_type">News Type <span class=" text-danger">*</span>
                                        </label>
                                        <select name="news_type" id="news_type" class="form-select select2" required>
                                            <option value="" selected disabled>Select Type</option>
                                            @foreach($newsTypeData as $singleNTD)
                                            <option value="{{$singleNTD}}" {{$singleNTD == 'Normal News' ? 'selected' : ''}}>{{$singleNTD}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    <div class="form-group custom-select2-form">
                                        ...
                                        <select name="is_published" id="is_published" class="form-select select2" required>
                                            ...
                                            @foreach($visibilityData as $singleVD)
                                            <option value="{{$singleVD}}" {{$singleVD == 'Published' ? 'selected' : ''}}>{{$singleVD}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    <div class="form-group custom-select2-form">
                                        <label for="layout_format">News Layout <span class=" text-danger">*</span>
                                        </label>
                                        <select name="layout_format" id="layout_format" class="form-select select2" required>
                                            ...
                                            <option value="{{$singleLD}}" {{$singleLD == 'Col 1' ? 'selected' : ''}}>{{$singleLD}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    <!-- Publish Time -->
                                    <div class="mb-3">
                                        <label for="publish_time">Publish Time <span class=" text-danger">*</span></label>
                                        <div class="form-grroup">
                                            <input type="text" class="form-control flatpickr-time text-left flatpickr-input custom-time-picker"
                                                id="publish_time" name="publish_time" placeholder="Publish Time" required value="">
                                        </div>
                                        @error('publish_time')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
...
@section('scripts')
    ...
    <script>
        ...
        // Visibility
        const visibilityText = $('#is_published').val();
        $('#visibilityText').text(visibilityText || 'Published');
        
        // News Type
        const newsTypeText = $('#news_type').val();
        $('#newsTypeText').text(newsTypeText || 'Normal News');
        ...
        $('#publishDateTimeText').text(publishDateTime);
        }
        ...
        $('#news_type').on('select2:select', updateCardBody);
