...
<div class="row py-3 ps-2">
    <div class="heading d-flex justify-content-start align-items-center">
        <h3 class="mb-0"><span>Documentation Create</span></h3>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="title_en" id="title_en" class="form-control"
                                    placeholder="Enter English Title" value="{{ old('title_en') }}" required>
                                @error('title_en')
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <label for="post_en" class="form-label mb-0">Description <span class="text-danger">*</span></label>
                                </div>
                                <textarea id="post_en" name="post_en" class="form-control summernote ">{{ old('post_en') }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <label for="photo_text_en" class="form-label mb-0">Photo Text <span class="text-danger"></span></label>
                                </div>
                                <textarea id="photo_text_en" name="photo_text_en" class="form-control summernote ">{{ old('photo_text_en') }}</textarea>
                                @error('photo_text_en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12">
                        <div class="card">
                            ...
                            <div class="card-body body-section">
                                <p>Published By: <b id="publishedByText">--</b></p>
                                <p>Visibility: <b id="visibilityText">Published</b></p>
                                <p>Published: <b id="publishDateTimeText">--</b></p>
                                <p>Documentation Layout: <b id="newsFormatText">Col 1</b></p>
                            </div>
                            <div class="card-footer">
                                <a href="javascript:void(0)" class="btn btn-primary w-100" data-bs-toggle="modal"
                                    data-bs-target="#modifyOthersInfo">Modify</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <select name="documentation_tag_id[]" id="documentation_tag_id" class="form-select select2" multiple></select>
                            ...
                            <div class="mb-3 col-md-6">
                                <div class="form-group custom-select2-form">
                                    ...
                                    <select name="published_by_id" id="published_by_id" class="form-select select2">
                                        ...
                                        <option value="{{ $singleUData->id }}"
                                            {{ old('published_by_id') == $singleUData->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3 col-md-6">
                                <div class="form-group custom-select2-form">
                                    ...
                                    <select name="is_published" id="is_published" class="form-select select2" required>
                                        ...
                                        <option value="{{$singleVD}}" {{$singleVD == 'Published' ? 'selected' : ''}}>
                                            {{$singleVD}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                <div class="form-group custom-select2-form">
                                    ...
                                    <select name="layout_format" id="layout_format" class="form-select select2" required>
                                        ...
                                        <option value="{{$singleLD}}" {{$singleLD == 'Col 1' ? 'selected' : ''}}>{{$singleLD}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-basic custom-date-picker"
                                        name="publish_date" id="publish_date" placeholder="DD-MM-YYYY"
                                        value="{{Carbon\Carbon::parse($todayDate)->format('d-m-Y')}}" required>
...
<script>
    ...
    function checkValidate() {
        ...
        if (!publishedBy || publishedBy === "") {
            ...
            $('#published_by_id').next('.select2-container').addClass('border-danger');
            alert('Please select a Published By user.');
            return false;
        } else {
            $('#published_by_id').next('.select2-container').removeClass('border-danger');
        }
