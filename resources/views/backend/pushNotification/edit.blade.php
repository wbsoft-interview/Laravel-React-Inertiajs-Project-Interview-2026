...
<div class="row py-3 ps-2">
    <div class="heading d-flex justify-content-start align-items-center">
        <h3 class="mb-0"><span> Timely Notification Update</span></h3>
    </div>
</div>
...
<div class="app-content content ">
    <div class="card">
        <div class="card-body">
            <form action="{{route('push-notification.update',$pushNotification->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class=" form-control flatpickr-basic custom-date-picker"
                                    name="sending_date" id="sending_date" placeholder="DD-MM-YYYY" 
                                    value="{{Carbon\Carbon::parse($pushNotification->sending_date)->format('d-m-Y')}}" required>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class=" form-control flatpickr-time custom-time-picker"
                                    name="sending_time" id="sending_time" placeholder="HH:MM" 
                                    value="{{$pushNotification->sending_time}}" required>
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class=" form-control" name="notification_title"
                                    id="notification_title" placeholder="Title" 
                                    value="{{$pushNotification->notification_title}}" required>
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class=" form-control" name="notification_message" id="notification_message"
                                    cols="20" rows="5" placeholder="Message">{!! $pushNotification->notification_message !!}</textarea>
