  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <h2 class="card-title fw-bolder mb-1">Number Change</h2>
        ...
        <form  method="POST" action="{{ route('change-number-submit') }}">
        @csrf

            <input type="hidden" name="mobile" value="{{$mobile}}">
          	<div class="form-group">
                <label class="form-label" for="new_mobile">Number</label>
                  <input name="new_mobile" type="text" 
                        class="form-control" 
                           required autofocus placeholder="Type Number">
            ...
            <br>
          <button type="submit" class="btn btn-primary w-100" tabindex="4">Change</button><br><br>
        </form>
