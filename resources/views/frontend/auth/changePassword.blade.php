...
<body>
    <div class="mobile-body no_scroll pt-2">
        ...
        <div style="min-height: 90% !important;" class="h-100 justify-content-center flex-column d-flex px-2 mb-5">
            <form action="{{route('webuser.get-password-update')}}" method="POST" enctype="multipart/form-data"
                autocomplete="false" class="needs-validation container card mt-3" novalidate>
                @csrf
                <h3 class="text-center heading_text py-2">Password Update</h3>
                ...
                <div class="condition pt-2">
                    <button type="submit" class="primary_btn custom-common-submit-button">Change Password</button>
                </div>
            </form>
        </div>
